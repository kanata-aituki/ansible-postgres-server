...
echo "================================================="
echo " PostgreSQL + Ansible 環境セットアップを開始します "
echo "================================================="
...
if ! command -v ansible &> /dev/null; then
    ...
    # epel-releaseリポジトリを追加（Ansibleをインストールするために必要なことが多い）
...
# 2. 依存コレクションのインストール
# ==============================================================================
echo "Ansibleコレクション (PostgreSQL操作用モジュール等) をインストールしています..."
# requirements.yml に定義された依存関係をダウンロードしてインストールする
ansible-galaxy collection install -r requirements.yml

# ==============================================================================
# 3. 機密情報ファイル (secret.yml) の準備確認
# ==============================================================================
# group_vars/secret.yml の存在チェック
...
# ==============================================================================
echo "Playbook (site.yml) を実行し、PostgreSQLの設定を開始します..."
echo "※パスワード等は group_vars/secret.yml の値が使用されます。"

# Playbookを実行する。インベントリファイル (-i hosts) と メインファイル (site.yml) を指定
